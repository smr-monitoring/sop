...
1. Select the logger, and if not already done, stop the logger.

1. Select “configure,” and enter the start date and time, and sampling interval. Select “save changes.” 

1. Select “start logging,” which will still delay deployment until the designated time.

### Deploying the Logger

**General deployment advice**

- The pendant should be attached to a solid surface or frame (such as a cage) rather than suspended from a line. It should be level and clear of any objects that could cast shade on the light sensor.
...
**Deploying the logger**
- Open the logger and inspect the o-ring and surroundig plastic housing for dirt and debris. If necessary, use a lint-free alcohol wipe to clean these surfaces and lubricate the o-ring with silicone grease.

- Using zip ties, secure the logger to a sturdy, level, surface, object, etc.
...
1. Open HOBO Connect, and connect the logger to your smartphone as described in the first section. Stop the logger.
...
3. Select the most recent data file, and export as a CSV file to the project-specific shared Google Drive.

4. Change the file name in Google Drive using project-specific naming conventions.
